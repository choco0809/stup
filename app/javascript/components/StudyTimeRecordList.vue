...
export default {
  ...
  setup() {
    ...
    const openEditModal = (record) => {
      store.commit('updateEditStudyTimeRecord', { id: record.id, startedAt: record.started_at, endedAt: record.ended_at, memo: record.memo })
